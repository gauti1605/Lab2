...
public class HbaseStart
{
	...
	public static void createTable() throws IOException
	{
		...
		try {
			// HBaseConfiguration hc = new HBaseConfiguration(new Configuration());
			  ...
			  HTableDescriptor ht = new HTableDescriptor("SensorTagGroup6Goutham"); 
		...
		//	  ht.addFamily( new HColumnDescriptor("longitude"));
			  ...
			  ht.addFamily( new HColumnDescriptor("Gyroscope Values"));
	...
	public static void insertTable() throws IOException{
		...
		config.clear();
         ...
         String latitude="",longitude="",Date="",x="",y="",z="",gyroX="",gyroY="",gyroZ="";

		  HTable table = new HTable(config, "SensorTagGroup6Goutham");
        ...
        BufferedReader br = null;
 		...
 		try {
 			...
 			br = new BufferedReader(new FileReader("C://sensorGouthamFinalGyro.txt"));
 			...
 			while ((sCurrentLine = br.readLine()) != null) {
 				...
 				p.add(Bytes.toBytes("Gyroscope Values"), Bytes.toBytes("col"+(count+4)),Bytes.toBytes(gyroX+","+gyroY+","+gyroZ));
	...
	public static void deleteTable() throws IOException{
		...
		config.clear();
         ...
         HBaseAdmin admin = new HBaseAdmin(config);
         admin.disableTable("SensorTagGroup6Goutham");
         admin.deleteTable("SensorTagGroup6Goutham");
